...
Revision ID: 72a1fb8a0d7f
Revises: 
Create Date: 2020-05-27 18:11:14.558300
...
def upgrade():
    ...
    sa.Column('q_type', sa.Enum('mc_single_answer', 'mc_multiple_answer', 'likert', 'binary', name='questiontype'), nullable=False),
