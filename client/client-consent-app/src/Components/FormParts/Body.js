        ...
        <div className="Body">
            <div>
                <Typography variant="h6" component="div">
                    Titel van onderzoek: <br/><span className="Titles">Hoe denk jij over ...? </span>
                </Typography>
                <Typography variant="h6" component="div">
                    Hoofdonderzoeker(s):
                    <br/>
                    <span className="Titles">Felienne Hermans,<br/> Fenia Aivaloglou</span>
                </Typography>
                <Typography variant="h6" component="div">
                ...
                <Typography variant="h6" component="div">
                    Onderzoeksgroep: <br/><span className="Titles"> Programming Education Research Group, Universiteit Leiden</span>
                </Typography>
            </div>
